...
RUN apk update && apk add python3 python3-dev nodejs npm zip bash libpng libpng-dev gcc g++ make autoconf automake libtool nasm openjdk8 openjdk8-jre git curl grep sed unzip
